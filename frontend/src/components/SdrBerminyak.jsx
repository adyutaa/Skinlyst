...
import BerminyakST from './image/BerminyakST.svg';
// import logo from './logo.svg';
import './style.css';
import {Navbar,Container,Form,Button} from 'react-bootstrap';


const SliderBerminyak = () => {
  return (
    ...
    <Navbar>
      ...
      <div className='mt-4'>
        <img src={BerminyakST} className='app-logo mx-auto d-block' alt="logo" fluid />

        <div id="form-wrapper" className="Slider">
  <Form action="/p/quote.php" method="GET">
    <h1 id="form-title">Berminyak</h1>
...
export default SliderBerminyak;
